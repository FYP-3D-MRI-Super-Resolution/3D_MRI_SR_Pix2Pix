...
for l in ${lone[@]}; do
  for ll in ${ltwo[@]}; do
    ...
    --lambda_L1 $l --lambda_L2_T $ll --gpu_id 0,1,2,3 --suffix {model}_{batch_size}_{lambda_L1}_{lambda_L2_T} \
    --dataroot /input --checkpoints_dir /checkpoints > "/checkpoints/out_${b}_${l}_${ll}.txt"
  done
done